...
mesh = gf.Mesh("load", "./mesh/fine-quadrilateron-1d.msh")
...
mfu.save("fine-quadrilateron-1d.mfu")

mim = gf.MeshIm(mesh, elements_degree * 2)
mim.save("fine-quadrilateron-1d.mim")
...
pl.show(cpos="xy", screenshot="fine-quadrilateron-1d.png")
