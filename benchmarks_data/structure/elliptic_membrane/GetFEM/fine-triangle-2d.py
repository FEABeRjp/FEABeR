...
mesh = gf.Mesh("load", "./mesh/fine-triangle-2d.msh")
...
mfu.save("fine-triangle-2d.mfu")

mim = gf.MeshIm(mesh, elements_degree * 2)
mim.save("fine-triangle-2d.mim")
...
mfu.export_to_vtk(
    "fine-triangle-2d.vtk", "ascii", mfd, sigmayy, "sigmayy", mfu, RHS, "RHS", U, "U"
)

m = pv.read("fine-triangle-2d.vtk")
pl = pv.Plotter()
...
for i in [50, 53, 55, 62, 64, 70, 73, 75, 84, 94, 95, 102, 103]:
    pl.add_point_labels(
        m.points[i],
...
pl.show(cpos="xy", screenshot="fine-triangle-2d.png")
