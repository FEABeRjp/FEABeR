...
mesh = gf.Mesh("load", "./mesh/fine-quadrilateron-2d.msh")
...
mfu.export_to_vtk("fine-quadrilateron-2d.vtk", "ascii", mfd, sigmayy, "sigmayy")
...
pl.show(cpos="xy", screenshot="fine-quadrilateron-2d.png")
