...
mesh.save("coarse-triangle.msh")
mesh.export_to_vtk("coarse-triangle.vtk", "ascii")

m = pv.read("coarse-triangle.vtk")
m.plot(cpos="xy", show_edges=True, screenshot="coarse-triangle.png")
