...
mesh.save("fine-quadrilateron.msh")
mesh.export_to_vtk("fine-quadrilateron.vtk", "ascii")

m = pv.read("fine-quadrilateron.vtk")
m.plot(cpos="xy", show_edges=True, screenshot="fine-quadrilateron.png")
