...
mesh.save("coarse-quadrilateron.msh")
mesh.export_to_vtk("coarse-quadrilateron.vtk", "ascii")

m = pv.read("coarse-quadrilateron.vtk")
m.plot(cpos="xy", show_edges=True, screenshot="coarse-quadrilateron.png")
