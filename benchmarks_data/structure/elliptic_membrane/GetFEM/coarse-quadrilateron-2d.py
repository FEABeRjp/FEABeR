...
mesh = gf.Mesh("load", "./mesh/coarse-quadrilateron-2d.msh")
...
mfu.save("coarse-quadrilateron-2d.mfu")

mim = gf.MeshIm(mesh, elements_degree * 2)
mim.save("coarse-quadrilateron-2d.mim")
...
m = pv.read("coarse-quadrilateron-2d.vtk")
pl = pv.Plotter()
...
pl.show(cpos="xy", screenshot="coarse-quadrilateron-2d.png")
